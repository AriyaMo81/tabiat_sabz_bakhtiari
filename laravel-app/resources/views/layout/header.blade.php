...
<head>
    ...
    <title>tabiat_sabz_bakhtiari @yield('title')</title>
    ...
    <div class="{{ request()->is('/') ? '' : 'sub_page' }}">
        ...
        <div class="hero_area">
            ...
            <div class="bg-box">
                ...
                <img src="{{ asset("./images/hero-bg-1.png") }}" alt="">

            </div>

            <!-- header section strats -->

            <header class="header_section" style="padding-top: 25px;">
                ...
                <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg custom_nav-container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav mx-auto" href="{{ request()->is('/') ? 'active' : '' }}">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" href="menu.html">محصولات</a>
